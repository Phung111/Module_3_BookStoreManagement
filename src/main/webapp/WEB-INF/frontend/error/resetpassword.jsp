    ...
    <div class="card card-authentication1 mx-auto my-5">
        <div class="card-body">
            <div class="card-content p-2">
                ...
                <div class="card-title text-uppercase text-center py-3">Bộ phận chăm sóc khách hàng</div>

                <div class="text-center mt-3">Gọi 0766606996 để lấy lại mật khẩu</div>
                <br>

                <a href="/login"><button type="button" class="btn btn-light btn-block">Quay lại Sign In</button></a>
            </div>
        </div>
    </div>
